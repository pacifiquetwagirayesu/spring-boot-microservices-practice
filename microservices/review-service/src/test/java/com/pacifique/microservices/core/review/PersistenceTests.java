...
public class PersistenceTests extends MySqlTestBase{
    ...
    void setUp() {
        ...
        ReviewEntity entity = ReviewEntity.builder().productId(1).reviewId(2).author("a").subject("s").content("c").build();
    ...
    @Test
    void create(){
        ReviewEntity newEntity = ReviewEntity.builder().productId(1).reviewId(3).author("a").subject("s").content("c").build();
    ...
    void optimisticLockError(){
        ...
        // Get the updated entity from the database and verify its new set
